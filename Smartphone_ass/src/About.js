function About(){
    return(
        <>
            <section class="text-gray-600 body-font about-container">
    ...
    <div class="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
      <img class="object-cover object-center w-full h-full" src="https://formwebdesign.ca/wp-content/uploads/2019/04/business-website-blue-background.jpg" alt="stats"/>
    </div>
  </div>
</section>

<section class="text-gray-600 body-font about-con-1">
