    ...
    return(<>
      <section class="text-gray-600 body-font mainContainer">
        ...
        <div class="inline-flex items-center justify-center">
            <img src={data.avatar} className="imagede"></img>
        </div>
        <div class="flex flex-col items-center text-center justify-center">
            <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">{data.name}</h2>
            ...
            <h6 style={{textAlign:"center"}} className="text-light">{data.mobileno}</h6>
        ...
        <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          ...
          {/* -----------------DELETE API----------------- */}
          <button onClick={()=>{
             fetch('https://630ce281b37c364eb7fbd9d2.mockapi.io/students/' + param.id,{method:"DELETE"})
             .then((res)=>{
              navigate('/Student')
             })
